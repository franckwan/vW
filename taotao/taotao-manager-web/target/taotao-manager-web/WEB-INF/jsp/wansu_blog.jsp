...
<head>
    ...
    <link href="wansuBlog/css/index.css" rel="stylesheet">
    <!--[if lt IE 9]>
...
<div class="banner">
    ...
    <ul class="texts">
        <p><img src="wansuBlog/images/t-1.png" alt="人生，是一场盛大的遇见"></p>
        <p><img src="wansuBlog/images/t-2.png" alt="若你懂得，就请珍惜。"></p>
        <p><img src="wansuBlog/images/t-3.png" alt="无论下多久的雨，最后都会有彩虹；无论你多么悲伤，要相信幸福在前方等候"></p>
    </ul>
</div>
<div class="blank"></div>
...
<article>
    <div class="l_box">
        <div class="about_me">
            <h2>关于我</h2>
            <ul>
                <img src="wansuBlog/images/boy.jpg">
                <p>网名：牙齿晒太阳</p>
                <p>主页：www.3dst.com</p>
                <p>职业：3DST技术网站长</p>
            </ul>
        ...
        <div class="about_he">
            <h2>关于她</h2><ul>
            <img src="wansuBlog/images/girl.jpg">
    ...
    <!--l_box end -->
    <div class="r_box">
        <li> <a href="/"><img src="wansuBlog/images/01.jpg"></a>
            <h3><a href="/">你是什么人便会遇上什么人</a></h3>
            <p>有时就为了一句狠话，像心头一口毒钉，永远麻痺着亲密感情交流。恶言，真要慎出，平日多誠心爱语，乃最简易之佈施。</p>
        </li>
        <li> <a href="/"><img src="wansuBlog/images/02.jpg"></a>
